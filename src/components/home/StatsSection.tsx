...
export function StatsSection() {
  ...
  return (
    <section ref={ref} className="bg-atlas-red">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4">
          {stats.map((stat, i) => (
            <motion.div
              ...
              className="py-10 lg:py-14 px-6 lg:px-10 text-center border-r border-white/10 last:border-r-0 even:border-r-0 lg:even:border-r"
            >
